        ...
        <div className="py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              <Link href="/" className="font-heading font-bold text-2xl text-primary mb-4 block">
                Wiz Dev Studios
              </Link>
              <p className="text-muted-foreground mb-6 max-w-md leading-relaxed">
                Transforming ideas into digital products with modern technologies and best practices. Building scalable
                web and software solutions for businesses worldwide.
              </p>
              ...
              <div className="flex gap-4">
                ...
                <Button
                  ...
                  asChild
                >
                  <a href="https://twitter.com/_wiz001" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
            ...
            {/* Quick Links */}
            <div>
              <h3 className="font-heading font-semibold text-lg text-card-foreground mb-4">Quick Links</h3>
            ...
            {/* Services */}
            <div>
              <h3 className="font-heading font-semibold text-lg text-card-foreground mb-4">Services</h3>
              <nav className="space-y-3">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-1 text-sm text-muted-foreground">
               Wiz Dev Studios <span className="text-xs">™</span> 2023
              </div>
            </div>
